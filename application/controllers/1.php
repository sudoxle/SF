...
<body id="page-top" class="landing-page">
            ...
            <div class="item active">
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p>
                            <a class="btn btn-lg btn-primary" href="<?= site_url('home/main_organization 1') ?>" role="button">READ MORE</a>
    ...
    <!-- END REGISTRATION -->
    <!-- OFFERINGS -->
    <section id="offerings" class="container features">
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="navy-line"></div>
        ...
        <div class="row features-block">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <select class="form-control" name="organization_course_type">
                        <option value="all">All</option>
                ...
                <div class="col-sm-5">
                    <input class="form-control" type="text" name="search_keyword" placeholder="Course or Organization Name" />
                </div>
                <!-- END TOP CONTENT -->
            </div>
            <hr>
            <!-- SCHOLARSHIP OFFERS -->
            <div id="organizations_grid">
                <?= $organizations_grid ?>
            </div>
            <!-- END OF SCHOLARSHIP OFFERS -->
        </div>
    </section>
    <!-- END OFFERINGS -->
